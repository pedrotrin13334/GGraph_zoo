...
# This file was *autogenerated* from the file comm_graph_small_groups.sage
...
for G in list(small_groups):
    ...
    file_str = f'comm_graph_plots/{group_id[_sage_const_0 ]}_{group_id[_sage_const_1 ]}_comm_graph.html'
